    ...
    <>
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-[#e7edf3] dark:border-slate-800 px-6 py-4 lg:px-40 bg-white dark:bg-background-dark sticky top-0 z-50">
        <Link to="/" className="flex items-center gap-3 text-primary">
          ...
          <h2 className="text-[#0e141b] dark:text-white text-xl font-bold leading-tight tracking-tight">DiaperCompare</h2>
        </Link>
        <div className="flex flex-1 justify-end gap-8 items-center">
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a className="text-[#0e141b] dark:text-slate-300 text-sm font-medium hover:text-primary transition-colors" href="#">Buying Guide</a>
          </nav>
        </div>
      </header>
      {/*
      ...
      <aside
        className={`fixed top-0 left-0 h-full w-80 bg-gray-900 tsext-white shadow-2xl z-50 transform transition-transform duration-300 ease-in-out flex flex-col ${
