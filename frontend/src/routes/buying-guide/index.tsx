...
export const Route = createFileRoute('/buying-guide/')({
    ...
    return <main>
                ...
                <div
                    ...
                    <div className="relative z-20 max-w-2xl">
                        ...
                        <p className="text-white/90 text-lg font-normal leading-relaxed mb-8">
                            A comprehensive guide for new parents to find the perfect fit, comfort, and protection
        ...
        <div className="max-w-[1200px] mx-auto w-full px-6 lg:px-10 py-12" id="types">
            <div className="flex items-center justify-between mb-8">
                <h2 className="text-[#111813] dark:text-white text-3xl font-bold tracking-tight">Types of Diapers</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div
                    ...
                    <div className="p-5 flex flex-col gap-2">
                        <p className="text-[#111813] dark:text-white text-lg font-bold">Disposables</p>
                        <p className="text-[#63886f] dark:text-gray-400 text-sm leading-relaxed">Ultimate convenience
                            and high absorption for everyday use.</p>
                ...
                <div
                    ...
                    <div className="p-5 flex flex-col gap-2">
                        <p className="text-[#111813] dark:text-white text-lg font-bold">Cloth &amp; Eco-friendly</p>
                        <p className="text-[#63886f] dark:text-gray-400 text-sm leading-relaxed">Sustainable choices for
                            sensitive skin and reduced waste.</p>
                        <a className="mt-2 text-primary text-sm font-semibold flex items-center gap-1" href="#">
                            Learn More <span className="material-symbols-outlined text-sm">chevron_right</span>
                        </a>
                    </div>
                ...
                <div
                    ...
                    <div className="p-5 flex flex-col gap-2">
                        <p className="text-[#111813] dark:text-white text-lg font-bold">Pants &amp; Pull-ups</p>
                        <p className="text-[#63886f] dark:text-gray-400 text-sm leading-relaxed">Perfect for active
                            crawlers and toilet training stages.</p>
                        <a className="mt-2 text-primary text-sm font-semibold flex items-center gap-1" href="#">
                            Learn More <span className="material-symbols-outlined text-sm">chevron_right</span>
                        </a>
                    </div>
                ...
                <div
                    ...
                    <div className="p-5 flex flex-col gap-2">
                        <p className="text-[#111813] dark:text-white text-lg font-bold">Overnight</p>
                        <p className="text-[#63886f] dark:text-gray-400 text-sm leading-relaxed">Maximum capacity for up
                            to 12 hours of dry sleep.</p>
                        <a className="mt-2 text-primary text-sm font-semibold flex items-center gap-1" href="#">
                            Learn More <span className="material-symbols-outlined text-sm">chevron_right</span>
                        </a>
                    </div>
        ...
        <div className="bg-primary/10 dark:bg-primary/5 py-16" id="features">
            <div className="max-w-[1200px] mx-auto px-6 lg:px-10">
                <div className="text-center mb-12">
                    ...
                    <p className="text-[#63886f] dark:text-gray-400 max-w-xl mx-auto">Don't just buy on price. Ensure
                        these essential features are present to keep your baby's skin healthy and dry.</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div
                        ...
                        <h3 className="text-xl font-bold mb-3">Superior Absorption</h3>
                        <p className="text-[#63886f] dark:text-gray-400">Core technology that pulls moisture away from
                            skin instantly to prevent diaper rash.</p>
                    </div>
                    <div
                        className="flex flex-col items-center text-center p-8 bg-white dark:bg-background-dark rounded-3xl shadow-sm">
                        <div
                        ...
                        <h3 className="text-xl font-bold mb-3">Breathable Materials</h3>
                        <p className="text-[#63886f] dark:text-gray-400">Micro-pores that allow air to circulate while
                            keeping liquids locked inside.</p>
                    </div>
                    <div
                        className="flex flex-col items-center text-center p-8 bg-white dark:bg-background-dark rounded-3xl shadow-sm">
                        <div
                        ...
                        <h3 className="text-xl font-bold mb-3">Wetness Indicator</h3>
                        <p className="text-[#63886f] dark:text-gray-400">A color-changing strip that tells you exactly
                            when it's time for a fresh change.</p>
                    </div>
                </div>
            </div>
        </div>
        <div className="max-w-[1200px] mx-auto w-full px-6 lg:px-10 py-20" id="size-guide">
            <div className="flex flex-col lg:flex-row gap-12 items-center">
                <div className="w-full lg:w-1/2">
                    <h2 className="text-3xl font-bold mb-6">Size &amp; Fit Reference</h2>
                    <p className="text-[#63886f] dark:text-gray-400 mb-8 leading-relaxed">
                        Diaper sizes are based on weight, not age. Use our chart below as a starting point. If you
                        see red marks around the legs or frequent leaks, it's time to size up!
                    </p>
                ...
                <div className="w-full lg:w-1/2">
                    <div
                        ...
                        <div className="absolute -bottom-6 -right-6 bg-primary p-6 rounded-2xl shadow-xl max-w-[240px]">
                            <p className="text-[#111813] font-bold italic">"Finding the right fit stopped the leaks
                                overnight!"</p>
                            <p className="text-[#111813]/60 text-sm mt-2">— Sarah, Mom of 6-month-old</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div className="max-w-[1200px] mx-auto w-full px-6 lg:px-10 pb-20">
            <div
                ...
                <h2 className="text-4xl lg:text-5xl font-black mb-6 relative z-10">Ready to find the best price?</h2>
                <p className="text-gray-400 text-lg mb-10 max-w-2xl mx-auto relative z-10">We track daily prices from
                    top retailers like Amazon, Walmart, and Target to ensure you never overpay for your baby's
                    essentials.</p>
                <div className="flex flex-col sm:flex-row justify-center gap-4 relative z-10">
                    <button
                        className="bg-primary text-[#111813] px-10 py-4 rounded-xl font-bold text-lg hover:scale-105 transition-transform">Compare
                        Prices Now</button>
                    <button
                        className="bg-white/10 border border-white/20 px-10 py-4 rounded-xl font-bold text-lg hover:bg-white/20 transition-all">Setup
                        Price Alerts</button>
                </div>
            </div>
        </div>
